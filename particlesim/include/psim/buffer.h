...
/*
NOTE: Following John Carmac's advice in one of his articles. Keep computations consistent even when it mean computing redundnat data to achieve consistent performance results.
